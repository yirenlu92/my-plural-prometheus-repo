terraform {
  backend "gcs" {
    bucket = "ren-prom-cluster-2-tf-state"
    prefix = "ren-prom-cluster-2/bootstrap"
  }
...
### END MANUAL SECTION <<gcp-bootstrap>>
  ...
  cluster_name = "ren-prom-cluster-2"
  vpc_name_prefix = "plural-monitoring"
  externaldns_sa_name = "ren-prom-cluster-2-externaldns"
  gcp_location = "us-east1-b"
